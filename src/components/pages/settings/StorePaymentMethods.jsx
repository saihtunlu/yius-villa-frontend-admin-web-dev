              ...
              >
                ...
                <Stack spacing={1.5}>
                  ...
                  <Stack direction={'row'} justifyContent={'space-between'} alignItems={'center'}>
                    ...
                    <Typography variant="subtitle1" gutterBottom>
                      {paymentMethod.allow_in_website ? 'Yes' : 'No'}
                    </Typography>
                  </Stack>
          ...
          <form onSubmit={handleSubmit}>
            <Stack spacing={2.5} sx={{ mt: 2.5 }}>
              ...
              <FormControlLabel
                control={
                  <Switch
                    checked={selectedPaymentMethod.allow_in_website}
                    onChange={(event) => {
                      setSelectedPaymentMethod((preState) => {
                        return { ...preState, allow_in_website: !selectedPaymentMethod.allow_in_website };
                      });
                    }}
                    inputProps={{ 'aria-label': 'controlled' }}
                  />
                }
                label="Allow In Website"
              />
